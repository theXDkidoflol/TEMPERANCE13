...
/obj/effect/spawner/roguemap/code1orgrime
	icon_state = "pit"
	name = "code1"
	probby = 50
	spawned = list(/obj/effect/loretile/code1, /obj/effect/decal/cleanable/dirt/grime/grime4)

/obj/effect/spawner/roguemap/code2orgrime
	icon_state = "pit"
	name = "code2"
	probby = 50
